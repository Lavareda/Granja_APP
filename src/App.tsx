    ...
    <div className="flex min-h-screen items-center justify-center bg-[#f6f7f2] px-4 py-8 text-farm-ink">
      <section className="w-full max-w-md rounded-lg border border-stone-200 bg-white p-6 shadow-panel">
        ...
        {!isSupabaseConfigured && (
          <div className="mb-5 rounded-xl border border-stone-200 bg-stone-50 p-4 text-sm text-stone-700">
            <div className="mb-3 flex items-center gap-2">
              <AlertCircle className="h-4 w-4 shrink-0 text-amber-500" aria-hidden="true" />
              <p className="font-semibold text-farm-ink">Configuração necessária</p>
            </div>
            <p className="mb-3 text-xs leading-relaxed text-stone-500">
              Adicione as variáveis abaixo em{" "}
              <strong className="text-stone-700">Netlify → Site settings → Environment variables</strong>{" "}
              e faça um novo deploy.
            </p>
            <div className="space-y-2">
              <div className="rounded-lg border border-stone-200 bg-white px-3 py-2">
                <p className="font-mono text-xs font-semibold text-farm-green">VITE_SUPABASE_URL</p>
                <p className="mt-0.5 font-mono text-xs text-stone-400 break-all">https://dkdazpdaefmgfzexhtko.supabase.co</p>
              </div>
              <div className="rounded-lg border border-stone-200 bg-white px-3 py-2">
                <p className="font-mono text-xs font-semibold text-farm-green">VITE_SUPABASE_ANON_KEY</p>
                <p className="mt-0.5 text-xs text-stone-400">Supabase → Project Settings → API → <em>anon public</em></p>
              </div>
            </div>
            <p className="mt-3 text-xs text-stone-400">
              Sem configuração o app corre em <span className="font-medium text-stone-500">modo demo</span> com dados locais.
            </p>
          </div>
        )}
